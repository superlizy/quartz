package com.ele007.quartz.service.impl;

import com.ele007.quartz.constant.ScheduleConstants;
import com.ele007.quartz.domain.SysJob;
import com.ele007.quartz.mapper.SysJobMapper;
import com.ele007.quartz.service.ISysJobService;
import com.ele007.quartz.util.CronUtils;
import com.ele007.quartz.util.ScheduleUtils;
...
public class SysJobServiceImpl implements ISysJobService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void deleteJobByIds(String ids) throws Exception {
        long[] jobIds = Arrays.asList(ids.split(",")).stream().mapToLong(Long::parseLong).toArray();
